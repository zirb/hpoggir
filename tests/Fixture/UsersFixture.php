...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dir_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'alumno_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'users_ibfk_1' => ['type' => 'foreign', 'columns' => ['dir_id'], 'references' => ['direcciones', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
            'users_ibfk_2' => ['type' => 'foreign', 'columns' => ['alumno_id'], 'references' => ['alumnos', 'id'], 'update' => 'restrict', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
